  ...
  return <Container className='mt-2r pb-1r'>
      <div className='separateBar'></div>
            <ul className="listRS mt-2r">
                ...
                <li className='pulse'><a href="#"><img alt="Logo Instagram" className="imgRS" src="/insta_white.png" title="Abonnez-vous sur Instagram !" /></a></li>
                ...
                <li className='pulse'><a href="#"><img alt="Logo Artstation" className="imgRS" src="/art_white.png" title="Retrouvez-nous sur Artstation !" /></a></li>
            </ul>
  </Container>;
}
